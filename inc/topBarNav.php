...
<!-- Navbar -->
  ...
  background-color:darkblue;
      ...
      <nav class= "bg-darkblue w-100 px-2 py-1 position-fixed top-0" id="login-nav">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0): ?>
             <!-- <span class="mx-2"><img src="<//?= validate_image($_settings->userdata('avatar')) ?>" alt="User Avatar" id="student-img-avatar"></span>-->
              ...
              <span class="mx-2" style="color: white;">Hello, <?= !empty($_settings->userdata('email')) ? $_settings->userdata('firstname') : $_settings->userdata('username') ?></span>

              <span class="mx-1"><a href="<?= base_url.'classes/Login.php?f=student_logout' ?>"><i class="fa fa-power-off" style="color: #c30010;"></i></a></span>
